...
```{r horse-pop, out.width="80%", fig.cap="Horse Population",echo=FALSE}
knitr::include_graphics("../../results/horse_pops_plot.png")
```

Figure \@ref(fig:horse-pop): Horse populations for all provinces in Canada from 1906 - 1972
...
```{r horselarge, out.width="125%", fig.cap= "Horse Plot",echo=FALSE}
knitr::include_graphics("../../results/horse_pop_plot_largest_sd.png")
```

Figure \@ref(fig:horselarge): Horse populations for the province with the largest standard deviation
